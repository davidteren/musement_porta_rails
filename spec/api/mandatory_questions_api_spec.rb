...
# Unit tests for OpenapiClient::MandatoryQuestionsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MandatoryQuestionsApi' do
  before do
  ...
  describe 'test an instance of MandatoryQuestionsApi' do
    it 'should create an instance of MandatoryQuestionsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::MandatoryQuestionsApi)
    end
  end

  # unit tests for delete_catalog_experiences_experience_id_mandatory_questions_mandatory_question_id
  ...
  # @param mandatory_question_id The mandatory question ID.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_catalog_experiences_experience_id_mandatory_questions_mandatory_question_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_catalog_experiences_experience_id_mandatory_questions
  ...
  describe 'get_catalog_experiences_experience_id_mandatory_questions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_catalog_experiences_experience_id_mandatory_questions_mandatory_question_id
  ...
  describe 'get_catalog_experiences_experience_id_mandatory_questions_mandatory_question_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_catalog_experiences_experience_id_mandatory_questions
  ...
  # @return [MandatoryQuestion]
  describe 'post_catalog_experiences_experience_id_mandatory_questions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for put_catalog_experiences_experience_id_mandatory_questions_mandatory_question_id
  ...
  # @option opts [MandatoryQuestion] :mandatory_question 
  # @return [MandatoryQuestion]
  describe 'put_catalog_experiences_experience_id_mandatory_questions_mandatory_question_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
