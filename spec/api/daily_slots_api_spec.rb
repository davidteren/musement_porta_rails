...
# Unit tests for OpenapiClient::DailySlotsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DailySlotsApi' do
  before do
  ...
  describe 'test an instance of DailySlotsApi' do
    it 'should create an instance of DailySlotsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::DailySlotsApi)
    end
  end

  # unit tests for get_availability_experiences_experience_id_options_option_id_slots_daily_slots
  ...
  # @param date_from Filters results to those which take place on or after the specified date.
  # @param date_to Filters results to those which take place on or before the specified date.
  # @param [Hash] opts the optional parameters
  # @return [Array<AvailabilitySlotDaily>]
  describe 'get_availability_experiences_experience_id_options_option_id_slots_daily_slots test' do
    it 'should work' do
