...
# Unit tests for OpenapiClient::AvailabilitySlotsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AvailabilitySlotsApi' do
  before do
  ...
  describe 'test an instance of AvailabilitySlotsApi' do
    it 'should create an instance of AvailabilitySlotsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::AvailabilitySlotsApi)
    end
  end

  # unit tests for delete_availability_experiences_experience_id_options_option_id_slots
  ...
  # @param api_key The supplier&#39;s API key
  # @param experience_id The experience ID.
  # @param option_id The option ID.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_availability_experiences_experience_id_options_option_id_slots test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_availability_experiences_experience_id_options_option_id_slots_availability_slot_id
  ...
  # @param experience_id The experience ID.
  # @param option_id The option ID.
  # @param availability_slot_id The availability slot ID.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_availability_experiences_experience_id_options_option_id_slots_availability_slot_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_availability_experiences_experience_id_options_option_id_slots_availability_slot_id
  ...
  describe 'get_availability_experiences_experience_id_options_option_id_slots_availability_slot_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_availability_experiences_experience_id_options_option_id_slots_availability_slot_id
  ...
  # @return [AvailabilitySlot]
  describe 'patch_availability_experiences_experience_id_options_option_id_slots_availability_slot_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_availability_experiences_experience_id_options_option_id_slots
  ...
  # @return [AvailabilitySlot]
  describe 'post_availability_experiences_experience_id_options_option_id_slots test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for put_availability_experiences_experience_id_options_option_id_slots_availability_slot_id
  ...
  # @return [AvailabilitySlot]
  describe 'put_availability_experiences_experience_id_options_option_id_slots_availability_slot_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
