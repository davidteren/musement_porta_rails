...
# Unit tests for OpenapiClient::TimeSlotsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TimeSlotsApi' do
  before do
  ...
  describe 'test an instance of TimeSlotsApi' do
    it 'should create an instance of TimeSlotsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::TimeSlotsApi)
    end
  end

  # unit tests for get_availability_experiences_experience_id_options_option_id_slots_time_slots
  ...
  describe 'get_availability_experiences_experience_id_options_option_id_slots_time_slots test' do
    it 'should work' do
