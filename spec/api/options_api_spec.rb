...
describe 'OptionsApi' do
  ...
  # unit tests for delete_catalog_experiences_experience_id_options_option_id
  ...
  # @return [nil]
  describe 'delete_catalog_experiences_experience_id_options_option_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_catalog_experiences_experience_id_options
  ...
  # @return [Option]
  describe 'post_catalog_experiences_experience_id_options test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for put_catalog_experiences_experience_id_options_option_id
  ...
  # @option opts [Option] :option 
  # @return [Option]
  describe 'put_catalog_experiences_experience_id_options_option_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
