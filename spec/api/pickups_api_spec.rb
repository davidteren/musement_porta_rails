...
# Unit tests for OpenapiClient::PickupsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PickupsApi' do
  before do
  ...
  describe 'test an instance of PickupsApi' do
    it 'should create an instance of PickupsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::PickupsApi)
    end
  end

  # unit tests for delete_catalog_pickups_pickup_id
  # Remove pickup
  ...
  # @param pickup_id The pickup ID.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_catalog_pickups_pickup_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_catalog_pickups
  # Get pickups
  # @param accept Specify the format of the response.
  # @param accept_version The version of PORTA for the request.
  # @param [Hash] opts the optional parameters
  # @return [Array<Pickup>]
  describe 'get_catalog_pickups test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_catalog_pickups_pickup_id
  # Get pickup
  # @param accept Specify the format of the response.
  # @param accept_version The version of PORTA for the request.
  # @param pickup_id The pickup ID.
  # @param [Hash] opts the optional parameters
  # @return [Pickup]
  describe 'get_catalog_pickups_pickup_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_catalog_pickups
  # Create pickup
  # @param accept Specify the format of the response.
  # @param accept_version The version of PORTA for the request.
  # @param [Hash] opts the optional parameters
  ...
  # @return [Pickup]
  describe 'post_catalog_pickups test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
