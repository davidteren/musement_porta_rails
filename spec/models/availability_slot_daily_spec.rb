...
# Unit tests for OpenapiClient::AvailabilitySlotDaily
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AvailabilitySlotDaily do
  let(:instance) { OpenapiClient::AvailabilitySlotDaily.new }

  describe 'test an instance of AvailabilitySlotDaily' do
    it 'should create an instance of AvailabilitySlotDaily' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AvailabilitySlotDaily)
    end
  end
