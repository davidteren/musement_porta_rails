...
# Unit tests for OpenapiClient::DailySlot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DailySlot do
  let(:instance) { OpenapiClient::DailySlot.new }

  describe 'test an instance of DailySlot' do
    it 'should create an instance of DailySlot' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DailySlot)
    end
  end
