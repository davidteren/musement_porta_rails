...
# Unit tests for OpenapiClient::Pickup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Pickup do
  let(:instance) { OpenapiClient::Pickup.new }

  describe 'test an instance of Pickup' do
    it 'should create an instance of Pickup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Pickup)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["HOTEL", "MEETING_POINT"])
  ...
  describe 'test attribute "time_margin"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
