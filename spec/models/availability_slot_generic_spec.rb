...
# Unit tests for OpenapiClient::AvailabilitySlotGeneric
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AvailabilitySlotGeneric do
  let(:instance) { OpenapiClient::AvailabilitySlotGeneric.new }

  describe 'test an instance of AvailabilitySlotGeneric' do
    it 'should create an instance of AvailabilitySlotGeneric' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AvailabilitySlotGeneric)
    end
  end
