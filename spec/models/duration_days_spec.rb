...
# Unit tests for OpenapiClient::DurationDays
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DurationDays do
  let(:instance) { OpenapiClient::DurationDays.new }

  describe 'test an instance of DurationDays' do
    it 'should create an instance of DurationDays' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DurationDays)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DURATION_DAYS"])
