...
# Unit tests for OpenapiClient::MandatoryQuestion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MandatoryQuestion do
  let(:instance) { OpenapiClient::MandatoryQuestion.new }

  describe 'test an instance of MandatoryQuestion' do
    it 'should create an instance of MandatoryQuestion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MandatoryQuestion)
    end
  end

  describe 'test attribute "data_pattern"' do
    it 'should work' do
  ...
  describe 'test attribute "data_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DATE", "DECIMAL", "EMAIL", "INTEGER", "PHONE_NUMBER", "SELECT_ONE", "STRING"])
  ...
  describe 'test attribute "level"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BOOKING", "BY_PAX"])
      # validator.allowable_values.each do |value|
