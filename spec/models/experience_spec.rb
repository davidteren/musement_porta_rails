...
describe OpenapiClient::Experience do
  let(:instance) { OpenapiClient::Experience.new }
  ...
  describe 'test attribute "availability_slot_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DAILY", "OPEN", "TIME"])
      # validator.allowable_values.each do |value|
      #   expect { instance.availability_slot_type = value }.not_to raise_error
      # end
    end
  end
