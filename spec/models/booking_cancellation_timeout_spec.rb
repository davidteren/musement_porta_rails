...
# Unit tests for OpenapiClient::BookingCancellationTimeout
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BookingCancellationTimeout do
  let(:instance) { OpenapiClient::BookingCancellationTimeout.new }

  describe 'test an instance of BookingCancellationTimeout' do
    it 'should create an instance of BookingCancellationTimeout' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BookingCancellationTimeout)
    end
  end
  ...
  describe 'test attribute "ticket_numbers"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "unconfirmed"' do
    it 'should work' do
      ...
      #   expect { instance.unconfirmed = value }.not_to raise_error
      # end
    end
  end
