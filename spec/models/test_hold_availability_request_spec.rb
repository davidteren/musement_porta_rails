...
# Unit tests for OpenapiClient::TestHoldAvailabilityRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TestHoldAvailabilityRequest do
  let(:instance) { OpenapiClient::TestHoldAvailabilityRequest.new }

  describe 'test an instance of TestHoldAvailabilityRequest' do
    it 'should create an instance of TestHoldAvailabilityRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TestHoldAvailabilityRequest)
    end
  end
