...
# Unit tests for OpenapiClient::AvailabilityTimeSlot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AvailabilityTimeSlot do
  let(:instance) { OpenapiClient::AvailabilityTimeSlot.new }

  describe 'test an instance of AvailabilityTimeSlot' do
    it 'should create an instance of AvailabilityTimeSlot' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AvailabilityTimeSlot)
    end
  end
