...
# Unit tests for OpenapiClient::TestBookingConfirmationRequestBookingRequestsInnerMandatoryAnswersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TestBookingConfirmationRequestBookingRequestsInnerMandatoryAnswersInner do
  let(:instance) { OpenapiClient::TestBookingConfirmationRequestBookingRequestsInnerMandatoryAnswersInner.new }

  describe 'test an instance of TestBookingConfirmationRequestBookingRequestsInnerMandatoryAnswersInner' do
    it 'should create an instance of TestBookingConfirmationRequestBookingRequestsInnerMandatoryAnswersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TestBookingConfirmationRequestBookingRequestsInnerMandatoryAnswersInner)
    end
  end
  ...
  describe 'test attribute "mandatory_question_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
