...
# Unit tests for OpenapiClient::TestBookingConfirmationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TestBookingConfirmationRequest do
  let(:instance) { OpenapiClient::TestBookingConfirmationRequest.new }

  describe 'test an instance of TestBookingConfirmationRequest' do
    it 'should create an instance of TestBookingConfirmationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TestBookingConfirmationRequest)
    end
  end
  ...
  describe 'test attribute "booking_requests"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "pickup_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
