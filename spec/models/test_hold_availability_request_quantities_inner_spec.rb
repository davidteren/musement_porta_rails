...
# Unit tests for OpenapiClient::TestHoldAvailabilityRequestQuantitiesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TestHoldAvailabilityRequestQuantitiesInner do
  let(:instance) { OpenapiClient::TestHoldAvailabilityRequestQuantitiesInner.new }

  describe 'test an instance of TestHoldAvailabilityRequestQuantitiesInner' do
    it 'should create an instance of TestHoldAvailabilityRequestQuantitiesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TestHoldAvailabilityRequestQuantitiesInner)
    end
  end
  ...
  describe 'test attribute "guide_language"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
