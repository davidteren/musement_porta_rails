...
# Unit tests for OpenapiClient::AvailabilityOpenSlot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AvailabilityOpenSlot do
  let(:instance) { OpenapiClient::AvailabilityOpenSlot.new }

  describe 'test an instance of AvailabilityOpenSlot' do
    it 'should create an instance of AvailabilityOpenSlot' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AvailabilityOpenSlot)
    end
  end
