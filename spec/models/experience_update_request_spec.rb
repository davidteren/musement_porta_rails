...
# Unit tests for OpenapiClient::ExperienceUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ExperienceUpdateRequest do
  let(:instance) { OpenapiClient::ExperienceUpdateRequest.new }

  describe 'test an instance of ExperienceUpdateRequest' do
    it 'should create an instance of ExperienceUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ExperienceUpdateRequest)
    end
  end
  ...
  describe 'test attribute "experience_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "external_experience_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "external_experience_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
