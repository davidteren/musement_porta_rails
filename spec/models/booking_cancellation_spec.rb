...
# Unit tests for OpenapiClient::BookingCancellation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BookingCancellation do
  let(:instance) { OpenapiClient::BookingCancellation.new }

  describe 'test an instance of BookingCancellation' do
    it 'should create an instance of BookingCancellation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BookingCancellation)
    end
  end
