...
# Unit tests for OpenapiClient::AvailableHolderCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AvailableHolderCategory do
  let(:instance) { OpenapiClient::AvailableHolderCategory.new }

  describe 'test an instance of AvailableHolderCategory' do
    it 'should create an instance of AvailableHolderCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AvailableHolderCategory)
    end
  end
  ...
  describe 'test attribute "price_in_cents"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
