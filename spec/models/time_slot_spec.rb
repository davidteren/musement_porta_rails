...
# Unit tests for OpenapiClient::TimeSlot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimeSlot do
  let(:instance) { OpenapiClient::TimeSlot.new }

  describe 'test an instance of TimeSlot' do
    it 'should create an instance of TimeSlot' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TimeSlot)
    end
  end
  ...
  describe 'test attribute "pickup_ids"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
