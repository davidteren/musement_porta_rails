...
# Unit tests for OpenapiClient::EndDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EndDate do
  let(:instance) { OpenapiClient::EndDate.new }

  describe 'test an instance of EndDate' do
    it 'should create an instance of EndDate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::EndDate)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["END_DATE"])
