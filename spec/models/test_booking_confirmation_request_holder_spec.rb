...
# Unit tests for OpenapiClient::TestBookingConfirmationRequestHolder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TestBookingConfirmationRequestHolder do
  let(:instance) { OpenapiClient::TestBookingConfirmationRequestHolder.new }

  describe 'test an instance of TestBookingConfirmationRequestHolder' do
    it 'should create an instance of TestBookingConfirmationRequestHolder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TestBookingConfirmationRequestHolder)
    end
  end
