...
module OpenapiClient
  class OpenSlotsApi
    ...
    def get_availability_experiences_experience_id_options_option_id_slots_open_slots(accept, accept_version, experience_id, option_id, opts = {})
      data, _status_code, _headers = get_availability_experiences_experience_id_options_option_id_slots_open_slots_with_http_info(accept, accept_version, experience_id, option_id, opts)
      data
    end
    ...
    # @param option_id [String] The option ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(AvailabilityOpenSlot, Integer, Hash)>] AvailabilityOpenSlot data, response status code and response headers
    def get_availability_experiences_experience_id_options_option_id_slots_open_slots_with_http_info(accept, accept_version, experience_id, option_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots ...'
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && accept_version.nil?
        fail ArgumentError, "Missing the required parameter 'accept_version' when calling OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && experience_id.nil?
        fail ArgumentError, "Missing the required parameter 'experience_id' when calling OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots"
      end
      pattern = Regexp.new(/^(?!\-|\.|\_)[0-9a-z\-\.\_]{1,50}$/)
      if @api_client.config.client_side_validation && experience_id !~ pattern
        fail ArgumentError, "invalid value for 'experience_id' when calling OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots, must conform to the pattern #{pattern}."
      end

      # verify the required parameter 'option_id' is set
      if @api_client.config.client_side_validation && option_id.nil?
        fail ArgumentError, "Missing the required parameter 'option_id' when calling OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots"
      end
      pattern = Regexp.new(/^(?!\-|\.|\_)[0-9a-z\-\.\_]{1,50}$/)
      if @api_client.config.client_side_validation && option_id !~ pattern
        fail ArgumentError, "invalid value for 'option_id' when calling OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/supplier/availability/experiences/{experience_id}/options/{option_id}/slots/open_slots'.sub('{' + 'experience_id' + '}', CGI.escape(experience_id.to_s)).sub('{' + 'option_id' + '}', CGI.escape(option_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AvailabilityOpenSlot'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Supplier-sandbox', 'Supplier-production']

      new_options = opts.merge(
        :operation => :"OpenSlotsApi.get_availability_experiences_experience_id_options_option_id_slots_open_slots",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OpenSlotsApi#get_availability_experiences_experience_id_options_option_id_slots_open_slots\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
