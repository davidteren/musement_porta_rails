...
module OpenapiClient
  class TestBookingConfirmationRequest
    ...
    attr_accessor :booking_requests
    ...
    # The ID of an existing sandbox pickup, if any.  Note that the location of this property differs from its location in the confirmation request sent to your webhook service. 
    attr_accessor :pickup_id

    # The ID of an existing sandbox availability slot.  Note that the location of this property differs from its location in the confirmation request sent to your webhook service. 
    ...
    def self.openapi_types
      {
        :'booking_id' => :'String',
        :'booking_requests' => :'Array<TestBookingConfirmationRequestBookingRequestsInner>',
        :'hold_id' => :'String',
        :'holder' => :'TestBookingConfirmationRequestHolder',
        :'pickup_id' => :'String',
        :'slot_id' => :'String',
        :'request_id' => :'String'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TestBookingConfirmationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TestBookingConfirmationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'booking_requests')
        if (value = attributes[:'booking_requests']).is_a?(Array)
          self.booking_requests = value
        end
      else
        self.booking_requests = nil
      end
      ...
      if attributes.key?(:'pickup_id')
        self.pickup_id = attributes[:'pickup_id']
      end
    ...
    def list_invalid_properties
      ...
      if @booking_requests.nil?
        invalid_properties.push('invalid value for "booking_requests", booking_requests cannot be nil.')
      end
      ...
      if !@pickup_id.nil? && @pickup_id !~ pattern
        invalid_properties.push("invalid value for \"pickup_id\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if @booking_requests.nil?
      return false if @hold_id.nil?
      return false if @holder.nil?
      return false if !@pickup_id.nil? && @pickup_id !~ Regexp.new(/^(?!\-|\.|\_)[0-9a-z\-\.\_]{1,50}$/)
    ...
    # @param [Object] booking_requests Value to be assigned
    def booking_requests=(booking_requests)
      if booking_requests.nil?
        fail ArgumentError, 'booking_requests cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pickup_id Value to be assigned
    def pickup_id=(pickup_id)
      if pickup_id.nil?
        fail ArgumentError, 'pickup_id cannot be nil'
      end

      pattern = Regexp.new(/^(?!\-|\.|\_)[0-9a-z\-\.\_]{1,50}$/)
      if pickup_id !~ pattern
        fail ArgumentError, "invalid value for \"pickup_id\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          booking_requests == o.booking_requests &&
          hold_id == o.hold_id &&
          holder == o.holder &&
    ...
    def hash
      [booking_id, booking_requests, hold_id, holder, pickup_id, slot_id, request_id].hash
    end
