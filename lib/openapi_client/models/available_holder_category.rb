...
module OpenapiClient
  class AvailableHolderCategory
    ...
    # The holder category price in cents.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AvailableHolderCategory` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AvailableHolderCategory`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'price_in_cents')
        self.price_in_cents = attributes[:'price_in_cents']
      else
        self.price_in_cents = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @price_in_cents.nil?
        invalid_properties.push('invalid value for "price_in_cents", price_in_cents cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @price_in_cents.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          price_in_cents == o.price_in_cents
    end
    ...
    def hash
      [holder_category_id, max_quantity, min_quantity, price_in_cents].hash
    end
