...
module OpenapiClient
  class TestHoldAvailabilityRequestQuantitiesInner
    # The ID for an existing sandbox holder category.
    attr_accessor :holder_category_id

    # The requested language.  This property must follow the [ISO 639-1 standard](https://www.iso.org/iso-639-language-codes.html). 
    attr_accessor :guide_language
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TestHoldAvailabilityRequestQuantitiesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TestHoldAvailabilityRequestQuantitiesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'guide_language')
        self.guide_language = attributes[:'guide_language']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          guide_language == o.guide_language &&
          quantity == o.quantity
    end
    ...
    def hash
      [holder_category_id, guide_language, quantity].hash
    end
